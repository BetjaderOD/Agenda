        ...
        <div class="col-4">
            ...
            <form action="save-person" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="controllastname" name="lastname">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="controlTel" name="phone">
                </div>
                <div class="mb-3">
                    <label for="controlAddress" class="form-label">Direccion: </label>
                    <input type="text" class="form-control" id="controlAddress" name="address">
                </div>
                <div class="mb-3">
                    <label for="controlCurp" class="form-label">Curp: </label>
                    <input type="text" class="form-control" id="controlCurp" name="curp">
                </div>
                <div class="mb-3">
                    <label for="controlNss" class="form-label">Nss: </label>
                    <input type="text" class="form-control" id="controlNss" name="nss">
                </div>


                <button type="submit" class="btn btn-primary">Registrar</button>
                <button type="reset" class="btn btn-danger">Cancelar</button>
                <!--button regresar list person -->
